...
public sealed class ForcedMethodParametersInvocationsDiagnosticsAnalyzerTests
    : DiagnosticAnalyzerVerifier<ForceMethodParametersInvocationsDiagnosticsAnalyzer>
{
    [Fact]
