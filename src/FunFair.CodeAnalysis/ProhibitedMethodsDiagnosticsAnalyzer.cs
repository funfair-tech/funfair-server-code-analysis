...
public sealed class ProhibitedMethodsDiagnosticsAnalyzer : DiagnosticAnalyzer
{
    ...
    [
        Build(ruleId: Rules.RuleDontUseDateTimeNow,
        ...
        Build(ruleId: Rules.RuleDontUseArbitrarySqlForQueries,
              title: "Avoid use of inline SQL statements",
              message: "Only use ISqlServerDatabase.QueryArbitrarySqlAsync in integration tests",
              sourceClass: "FunFair.Common.Data.ISqlServerDatabase",
              bannedMethod: "QueryArbitrarySqlAsync"),
        Build(ruleId: Rules.RuleDontReadRemoteIpAddressDirectlyFromConnection,
        ...
        Build(ruleId: Rules.RuleDontUseGuidParse,
    ...
    private sealed class Checker
    {
        ...
        {
            return syntaxNodeAnalysisContext.SemanticModel.GetTypeInfo(expression: e, cancellationToken: syntaxNodeAnalysisContext.CancellationToken)
