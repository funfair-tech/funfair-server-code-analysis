...
| Code    | Meaning                                                                                                                                        |
|---------|------------------------------------------------------------------------------------------------------------------------------------------------|
| FFS0001 | Avoid using ``DateTime.Now`` - Use an injected ``System.TimeProvider``                                                                         |
| FFS0002 | Avoid using ``DateTime.UtcNow`` - Use an injected ``System.TimeProvider``                                                                      |
| FFS0003 | Avoid using ``DateTime.Today`` - Use an injected ``System.TimeProvider``                                                                       |
| FFS0004 | Avoid using ``DateTimeOffset.Now`` - Use an injected ``System.TimeProvider``                                                                   |
| FFS0005 | Avoid using ``DateTimeOffset.UtcNow`` - Use an injected ``System.TimeProvider``                                                                |
